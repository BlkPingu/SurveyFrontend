<template>
   <div>
      ...
      <p>Tobias Kolb, <br>Elsterstraße 1, <br>12055, Berlin, Berlin</p>
      ...
      <ul class="m-elements">
         <li><strong>DigitalOcean:</strong> Content-Delivery-Network (CDN); Dienstanbieter: DigitalOcean, LLC, 101 Avenue of the Americas, New York, New York 10013, USA; Website: <a href="https://www.digitalocean.com" target="_blank">https://www.digitalocean.com</a>; Datenschutzerklärung: <a href="https://www.digitalocean.com/legal/privacy-policy" target="_blank">https://www.digitalocean.com/legal/privacy-policy</a>.</li>
      </ul>
      <h3 id="m408">Umfragen und Befragungen</h3>
      ...
      <ul class="m-elements">
         ...
         <li><strong>Zwecke der Verarbeitung:</strong> Kontaktanfragen und Kommunikation, Direktmarketing (z.B. per E-Mail oder postalisch), Tracking (z.B. interessens-/verhaltensbezogenes Profiling, Nutzung von Cookies), Feedback (z.B. Sammeln von Feedback via Online-Formular).</li>
         <li><strong>Rechtsgrundlagen:</strong> Einwilligung (Art. 6 Abs. 1 S. 1 lit. a DSGVO), Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f. DSGVO).</li>
      </ul>
